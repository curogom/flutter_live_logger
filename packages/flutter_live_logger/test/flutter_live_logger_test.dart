...
void main() {
  group('Flutter Live Logger Tests', () {
    ...
    group('API Consistency Tests', () {
      ...
      test('FlutterLiveLogger should handle all log levels correctly',
          () async {
        ...
        // Test all log levels
        FlutterLiveLogger.trace('Trace message');
        FlutterLiveLogger.debug('Debug message');
        FlutterLiveLogger.info('Info message');
        FlutterLiveLogger.warn('Warning message');
        FlutterLiveLogger.error('Error message');
        FlutterLiveLogger.fatal('Fatal message');
        FlutterLiveLogger.event('test_event', {'key': 'value'});
